<?php
    ...
    $id = $_SESSION['codFunc'];
    $sql = "SELECT * FROM db_funcionarios WHERE codFunc = '$id'";
...
<div class="formularios">
    <div class="cablogout">
    <div class="encaplogout">
    <h3 style="background-color: #fff;">Logado como <?php echo $log['nomeFunc']."!";?></h3>
    </div>
    <div class="divlogout">
        <form action="AT06_search.php" method="POST">
            <input type="submit" name="logout" value="Deslogar" class="botaologout">
        </form>
    </div>
    </div>
<h1>Database</h1>
